...
// Keep the studio separate from library navigation and player rendering.
import { initLiveStudio } from './live.js?v=1';
initLiveStudio({api, state, escapeHtml, longDate, formatDuration});
